...
function SignIn() {
  ...
  function onKeyUp(e) {
    if (e.charCode === 13) onClickPostSignIn();
  }

  function onClickPostSignIn() {
    axios
      .post("https://chat-app-server-linh.herokuapp.com/account/signin", {
        email,
        password
      })
      .then((res) => {
        ...
        <div className="card-body">
          ...
          <Form onKeyPress={onKeyUp}>
            <FormGroup>
              ...
              />
              {invalidValue.email && (
                <FormText>{invalidValue.emailMessage}</FormText>
              )}
            </FormGroup>
            <FormGroup>
              ...
              />
              {invalidValue.password && <FormText>Password is wrong</FormText>}
            </FormGroup>
            <div className="mt-4">
              <button
            ...
            <div className="mt-2 text-center">
              <p>
                ...
                <a className="font-weight-medium text-primary" href="/signup">
                  {" "}
                  Signup now{" "}
                </a>{" "}
              </p>
